...
runApp(schema, root);
winston.level = "silly";
winston.log("silly", "Text silly", {});
winston.log("warn", "Text warn");
winston.log("error", "Text error");
winston.log("info", "Text info");
winston.log("verbose,", "Text verbose,");
winston.log("debug,", "Text debug,");
